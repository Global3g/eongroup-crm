  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Reportes y Analitica</h1>
        ...
        <>
          ...
          {activeTab === 'general' && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Distribucion del Pipeline</h3>
          ...
          {activeTab === 'pipeline' && (
            <div className="space-y-6">
              {/* Sales Funnel */}
              <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                <h3 className="text-lg font-semibold text-white mb-4">Embudo de Ventas</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Valor por Mes */}
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Valor Ganado por Mes</h3>
                ...
                <div className="bg-slate-900/50 backdrop-blur-sm rounded-2xl p-6 border-2 border-cyan-500/30" style={{ background: 'linear-gradient(135deg, rgba(15,23,42,0.7) 0%, rgba(6,182,212,0.05) 100%)' }}>
                  <div className="flex items-center gap-3 mb-4">
                    <div className="p-2 rounded-xl bg-cyan-500/20">
                      <Zap size={20} className="text-cyan-400" />
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white">Pronostico de Ventas</h3>
          ...
          {activeTab === 'actividades' && (
            <div className="space-y-6">
              ...
              <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                <h3 className="text-lg font-semibold text-white mb-4">Actividades por Tipo</h3>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {/* Actividades por Mes */}
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Actividades por Mes</h3>
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Distribucion de Actividades</h3>
          ...
          {activeTab === 'equipo' && usuarios && usuarios.length > 1 && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Valor Ganado por Persona</h3>
                ...
                {/* Activity comparison */}
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Actividades por Persona</h3>
          ...
          {activeTab === 'inteligencia' && (
            <div className="space-y-6">
              ...
              {(() => {
                ...
                return (
                  <div className="bg-gradient-to-br from-cyan-500/10 via-violet-500/10 to-cyan-500/5 backdrop-blur-sm rounded-2xl p-6 border-2 border-cyan-500/30">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="p-2 rounded-xl bg-cyan-500/20">
                        <Sparkles size={20} className="text-cyan-400" />
                      </div>
                      <h3 className="text-lg font-semibold text-white">Insights Automaticos</h3>
                    </div>
              ...
              {patrones.mejorMes && patrones.mejorMes.valor > 0 && (
                <div className="bg-gradient-to-r from-amber-500/10 via-yellow-500/10 to-amber-500/5 backdrop-blur-sm rounded-2xl p-6 border-2 border-amber-500/40">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Industrias con Mayor Conversion</h3>
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Servicios Mas Rentables</h3>
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <h3 className="text-lg font-semibold text-white mb-4">Fuentes de Leads Mas Efectivas</h3>
                ...
                <div className="bg-slate-800/40 backdrop-blur-md rounded-2xl p-6 border border-white/[0.08]">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-lg font-semibold text-white">Cuellos de Botella</h3>
                  </div>
